...
class Model(object):
  ...
  def __init__(self):
    ...
    self._burp_logfile_chooser = btn('打开')
    self._request_file = FileEntry()
    self._request_file_chooser = btn('打开')
    self._bulkfile = FileEntry()
    self._bulkfile_chooser = btn('打开')
    self._configfile = FileEntry()
    self._configfile_chooser = btn('打开')
  ...
  # 测试(Q)
    ...
    self._tech_area_second_req_chooser = btn('打开')
    # 性能优化
  ...
  # 请求(W)
    ...
    self._request_area_load_cookies_chooser = btn('打开')
    ...
    self._request_area_auth_file_chooser = btn('打开')
    ...
    self._request_area_safe_req_chooser = btn('打开')
  ...
  # 枚举(E)
    ...
    self._runsql_area_sql_file_chooser = btn('打开')
    # 暴破表名/列名
  ...
  # 文件(R)
    ...
    self._file_os_access_msf_path_chooser = btn('打开')
  ...
  # 其他(T)
    ...
    self._page1_general_preprocess_chooser = btn('打开')
    ...
    self._page1_misc_tmp_dir_chooser = btn('打开')
  ...
  # 日志区(3)
    self._page3_log_view = g.TextView()
    self._page3_read_target_btn = btn('查看target文件')
  ...
  # API区(4)
    ...
    self._page4_admin_flush_btn = btn('删除所有任务')
    self._page4_clear_task_view_btn = btn('清空反馈的结果')
    self._page4_option_get_entry = et()
    self._page4_option_set_view = g.TextView()
    self._page4_task_view = g.TextView()
  # 帮助(H)
    self._page5_manual_view = g.TextView()
